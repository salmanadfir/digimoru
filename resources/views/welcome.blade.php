   ...
   <nav>
      ...
      <div class="containerr">
         <ul>
            ...
            <li class="activate"><a style="text-decoration: none;" href="{{ route('login') }}">Login</a></li>
            <li class="active"><a style="text-decoration: none;" href="{{ route('register') }}">Register</a></li>
         </ul>
      </div>
   </nav>
</header>
        ...
        <div class="row">
           ...
           <div class="col-md-4">
            <div class="card mx-auto my-4" style="width: 14rem;">
                <img class="images w-75 h-75 my-2 mx-auto" src="{{url($path)}}" alt="Card image cap">
                <div class="card-body">
                  <h5 style="font-size: 16px;" class="card-title">{{ $brg->nama_barang }}</h5>
                <p style="font-size: 12px;" class="card-text">Rp. {{$brg->harga}}</p>
                <a href="/lihat/{{ $brg->id }}" class="btn btn-primary">Detail Barang</a>
                </div>
              </div>
           </div>
           @endforeach
