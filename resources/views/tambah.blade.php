   ...
   <nav>
      ...
      <div class="containerr">
         <ul>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/manajemenproduk') }}">Manajemen Produk</a>
            </li>
...
<article id="class" class="cardio">
         <section class="class">
             <div class="containerr">
                 <div class="row">
                     <div class="col-md-12">
                         <a href="{{ url('/manajemenproduk') }}" class="btn btn-dark"><i class="fa fa-arrow-left"></i> Kembali</a>
                 </div>
                             ...
                             <div class="col-md-6 mt-5">
                                <div class="container">
                                    ...
                                    @if (session('success'))
                                        ...
                                        @endalert
                                    @endif
                                    <form action="/manajemenproduk/tambahproduk" method="POST" enctype="multipart/form-data">
                                        @csrf
                                      <div class="form-group">
                                        <label for="Name">Nama Produk:</label>
                                        <input type="text" class="form-control" id="nama_barang" placeholder="Enter Nama Produk" name="nama_barang">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="gambar" placeholder="Enter Gambar" name="gambar">
                                        <p class="text-danger">{{ $errors->first('gambar') }}</p>
                                      </div>
                                      <button type="submit" class="btn btn-dark my-1">Tambah</button>
                                    </form>
                                  </div>
                         </div>
                     </div>
